...
namespace Space_Truckers.Controllers
{
    ...
    public class ShortestPathEndpoint : ControllerBase
    {
        ...
        public string ShortestPath(string from,string to)
        {
            ...
            Debug.WriteLine(planets[0].Name);
            Debug.WriteLine("c = "+currentPlanet.Name);
            Debug.WriteLine("d = "+destination.Name);
        ...
        private static void HandleCurrentPlanet(Planet currentPlanet)
        {
            ...
            for (int i = 0; i < connectedPlanets.Count; i++)
            {
                ...
                if (currentPlanet.PathWeight + connectedPlanets[i].ConnectedWeight < connectedPlanets[i].GetPlanet().PathWeight)
                {
                    ...
                    Debug.WriteLine("current = " + currentPlanet);
                    Debug.WriteLine("in planet = " + connectedPlanets[i].GetPlanet().PreviousPlanet);
                }
            }
        }
